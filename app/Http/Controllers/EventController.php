...
class EventController extends Controller
{
    ...
    # Aqui temos a função Event(nome da nossa Model) e o all() basicamente puxa tudo do nosso banco;
    ...
    public function dashboard(){
        ...
        return view('events.dashboard', ['events' => $events, 'eventAsParticipants' => $eventAsParticipants]);
